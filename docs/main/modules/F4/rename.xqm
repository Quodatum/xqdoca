		...
		</h1>
{
         ...
         xqh:variables-XQDOCA($xqd/xqdoc:variables),
...
as element(div)
{
  <div class="div2">
      ...
      count $index
	   return xqh:variable-XQDOCA($v,(3,$index)),
...
return
		<div class="div3">
			<h3><a id="{$id }"/>{ page:section-XQDOCA($section) } {$id }</h3>
			<dl>
      ...
      { xqh:when-XQDOCA($v/xqdoc:annotation,xqh:annotations#1) }
		</div>
};  
   ...
   return <div class="div2">
      ...
      <tbody>{ for $r in $rest
              ...
              return <tr>
                ...
                <td>{$methods!page:link-restxq-XQDOCA(. , true())}</td>
