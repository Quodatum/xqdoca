...
(:~ transform files to html
 ...
 : "project": "vue-poc"
 :)
declare function xqhtml:index-html2-XQDOCA($state as map(*),
                            $params as map(*)
                            )
as document-node()                            
{
...
return document{ xqhtml:page-XQDOCA($d, $params ) }
};
...
declare function xqhtml:tree-list($tree as element(*),$seq as xs:integer*){
  ...
  case element(directory) 
      return <li>
                 ...
                 <ol class="toc">{$tree/*!xqhtml:tree-list-XQDOCA(.,($seq,position()))}</ol>
             </li>
   case element(file) 
           ...
           <h3>
            ...
            <ol class="toc">
                ...
                <li>
                 ...
                 <ol  class="toc"> { $tree/*/*!xqhtml:tree-list-XQDOCA(.,2) } </ol>
                </li>
             </ol>
           </nav>
           <a href="index.html">index: </a>
          
           <ul>{$annots!xqhtml:path-to-html-XQDOCA(.)}</ul>
           </div>
return  xqhtml:page-XQDOCA($body,$opts)
};
